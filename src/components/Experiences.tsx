...
const Experiences: React.FC = () => {
  ...
  return (
    <section id="experiences" className="py-20 bg-gradient-to-br from-teal-50 to-blue-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
        ...
        <div className="max-w-4xl mx-auto relative">
            ...
            <div className="p-8 relative">
              ...
              <blockquote className="text-center mb-8">
                <p className="text-lg sm:text-xl text-gray-700 leading-relaxed mb-6 italic">
                  "{currentExperience.testimonial || currentExperience.description}"
                </p>
                <footer>
          ...
          <div className="absolute -bottom-4 -right-4 w-32 h-32 bg-gradient-to-br from-blue-200 to-purple-200 rounded-full opacity-50 animate-float" style={{ animationDelay: '2s' }}></div>
        </div>
