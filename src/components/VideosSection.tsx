...
const VideosSection: React.FC = () => {
  ...
  const [videos, setVideos] = useState<VideoData>({ video1: null, video2: null });
  ...
  const activeVideos = [videos.video1, videos.video2].filter(Boolean) as string[];
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-gray-50 via-white to-orange-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Videos Grid */}
        <div className={`grid grid-cols-1 ${activeVideos.length > 1 ? 'md:grid-cols-2' : ''} gap-8 max-w-6xl mx-auto`}>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-gray-700">
                    ...
                    <span className="font-semibold">Tour Video {index + 1}</span>
                  </div>
